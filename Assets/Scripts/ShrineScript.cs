...
public class ShrineScript : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        PowerInfo temppower = collision.gameObject.GetComponent<PlayerControllerTemp>().cur_power;
        collision.gameObject.GetComponent<PlayerControllerTemp>().changePower(power);
        power = temppower;
    }
    #endregion
}
